...
add wave -color white -format Analog-Step -radix unsigned sim:/tb_mov_avg_filter/tb_data_i
...
add wave -color white -format Analog-Step -radix unsigned sim:/tb_mov_avg_filter/tb_data_filtered

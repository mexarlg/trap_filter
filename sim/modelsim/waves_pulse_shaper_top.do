...
add wave -color white -format Analog-Step -radix signed sim:/tb_pulse_shaper_top/dut/trig_ss_i/pulse_detect_i/cfd_i/cfd_signal
add wave -color green -radix binary sim:/tb_pulse_shaper_top/dut/trig_ss_i/pulse_trig
add wave -color green -radix binary sim:/tb_pulse_shaper_top/dut/pulse_triggers_o
...
add wave -color white -format Analog-Step -radix signed sim:/tb_pulse_shaper_top/dut/trap_data_o
add wave -color white -format Analog-Step -radix signed sim:/tb_pulse_shaper_top/dut/peak_ss_i/data_mov_filt
add wave -color green -radix signed sim:/tb_pulse_shaper_top/dut/pulse_amplitude_o
...
add wave -color white -radix binary sim:/tb_pulse_shaper_top/dut/pulse_valid_o
add wave -color green -radix binary sim:/tb_pulse_shaper_top/dut/overflow_flags_o

#===========================================================================
# LOGGER_SS
#===========================================================================
add wave -divider " LOGGER_SS "
add wave -color green -radix hex sim:/tb_pulse_shaper_top/dut/log_time_o
add wave -color green -radix hex sim:/tb_pulse_shaper_top/dut/log_pulse_o
add wave -color green -radix unsigned sim:/tb_pulse_shaper_top/dut/time_cnt_o

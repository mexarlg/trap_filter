...
create_clock -period 10.000 -name sys_clk -waveform {0.000 5.000} -add [get_ports CLK_I]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {data_i[0]} {data_i[1]} {data_i[2]} {data_i[3]} {data_i[4]} {data_i[5]} {data_i[6]} {data_i[7]} {data_i[8]} {data_i[9]} {data_i[10]} {data_i[11]} {data_i[12]} {data_i[13]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 10 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {error_oflow[0]} {error_oflow[1]} {error_oflow[2]} {error_oflow[3]} {error_oflow[4]} {error_oflow[5]} {error_oflow[6]} {error_oflow[7]} {error_oflow[8]} {error_oflow[9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 32 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {log_pulse_data[0]} {log_pulse_data[1]} {log_pulse_data[2]} {log_pulse_data[3]} {log_pulse_data[4]} {log_pulse_data[5]} {log_pulse_data[6]} {log_pulse_data[7]} {log_pulse_data[8]} {log_pulse_data[9]} {log_pulse_data[10]} {log_pulse_data[11]} {log_pulse_data[12]} {log_pulse_data[13]} {log_pulse_data[14]} {log_pulse_data[15]} {log_pulse_data[16]} {log_pulse_data[17]} {log_pulse_data[18]} {log_pulse_data[19]} {log_pulse_data[20]} {log_pulse_data[21]} {log_pulse_data[22]} {log_pulse_data[23]} {log_pulse_data[24]} {log_pulse_data[25]} {log_pulse_data[26]} {log_pulse_data[27]} {log_pulse_data[28]} {log_pulse_data[29]} {log_pulse_data[30]} {log_pulse_data[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 24 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {pileup_cnt[0]} {pileup_cnt[1]} {pileup_cnt[2]} {pileup_cnt[3]} {pileup_cnt[4]} {pileup_cnt[5]} {pileup_cnt[6]} {pileup_cnt[7]} {pileup_cnt[8]} {pileup_cnt[9]} {pileup_cnt[10]} {pileup_cnt[11]} {pileup_cnt[12]} {pileup_cnt[13]} {pileup_cnt[14]} {pileup_cnt[15]} {pileup_cnt[16]} {pileup_cnt[17]} {pileup_cnt[18]} {pileup_cnt[19]} {pileup_cnt[20]} {pileup_cnt[21]} {pileup_cnt[22]} {pileup_cnt[23]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 15 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {pulse_amplitude[0]} {pulse_amplitude[1]} {pulse_amplitude[2]} {pulse_amplitude[3]} {pulse_amplitude[4]} {pulse_amplitude[5]} {pulse_amplitude[6]} {pulse_amplitude[7]} {pulse_amplitude[8]} {pulse_amplitude[9]} {pulse_amplitude[10]} {pulse_amplitude[11]} {pulse_amplitude[12]} {pulse_amplitude[13]} {pulse_amplitude[14]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 3 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list {pulse_state[0]} {pulse_state[1]} {pulse_state[2]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe6]
set_property port_width 12 [get_debug_ports u_ila_0/probe6]
connect_debug_port u_ila_0/probe6 [get_nets [list {pulse_t_rise[0]} {pulse_t_rise[1]} {pulse_t_rise[2]} {pulse_t_rise[3]} {pulse_t_rise[4]} {pulse_t_rise[5]} {pulse_t_rise[6]} {pulse_t_rise[7]} {pulse_t_rise[8]} {pulse_t_rise[9]} {pulse_t_rise[10]} {pulse_t_rise[11]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe7]
set_property port_width 7 [get_debug_ports u_ila_0/probe7]
connect_debug_port u_ila_0/probe7 [get_nets [list {pulse_triggers[0]} {pulse_triggers[1]} {pulse_triggers[2]} {pulse_triggers[3]} {pulse_triggers[4]} {pulse_triggers[5]} {pulse_triggers[6]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe8]
set_property port_width 15 [get_debug_ports u_ila_0/probe8]
connect_debug_port u_ila_0/probe8 [get_nets [list {pulse_trapezoid[0]} {pulse_trapezoid[1]} {pulse_trapezoid[2]} {pulse_trapezoid[3]} {pulse_trapezoid[4]} {pulse_trapezoid[5]} {pulse_trapezoid[6]} {pulse_trapezoid[7]} {pulse_trapezoid[8]} {pulse_trapezoid[9]} {pulse_trapezoid[10]} {pulse_trapezoid[11]} {pulse_trapezoid[12]} {pulse_trapezoid[13]} {pulse_trapezoid[14]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe9]
set_property port_width 32 [get_debug_ports u_ila_0/probe9]
connect_debug_port u_ila_0/probe9 [get_nets [list {log_timestamp_data[0]} {log_timestamp_data[1]} {log_timestamp_data[2]} {log_timestamp_data[3]} {log_timestamp_data[4]} {log_timestamp_data[5]} {log_timestamp_data[6]} {log_timestamp_data[7]} {log_timestamp_data[8]} {log_timestamp_data[9]} {log_timestamp_data[10]} {log_timestamp_data[11]} {log_timestamp_data[12]} {log_timestamp_data[13]} {log_timestamp_data[14]} {log_timestamp_data[15]} {log_timestamp_data[16]} {log_timestamp_data[17]} {log_timestamp_data[18]} {log_timestamp_data[19]} {log_timestamp_data[20]} {log_timestamp_data[21]} {log_timestamp_data[22]} {log_timestamp_data[23]} {log_timestamp_data[24]} {log_timestamp_data[25]} {log_timestamp_data[26]} {log_timestamp_data[27]} {log_timestamp_data[28]} {log_timestamp_data[29]} {log_timestamp_data[30]} {log_timestamp_data[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe10]
set_property port_width 48 [get_debug_ports u_ila_0/probe10]
connect_debug_port u_ila_0/probe10 [get_nets [list {timestamp_cnt[0]} {timestamp_cnt[1]} {timestamp_cnt[2]} {timestamp_cnt[3]} {timestamp_cnt[4]} {timestamp_cnt[5]} {timestamp_cnt[6]} {timestamp_cnt[7]} {timestamp_cnt[8]} {timestamp_cnt[9]} {timestamp_cnt[10]} {timestamp_cnt[11]} {timestamp_cnt[12]} {timestamp_cnt[13]} {timestamp_cnt[14]} {timestamp_cnt[15]} {timestamp_cnt[16]} {timestamp_cnt[17]} {timestamp_cnt[18]} {timestamp_cnt[19]} {timestamp_cnt[20]} {timestamp_cnt[21]} {timestamp_cnt[22]} {timestamp_cnt[23]} {timestamp_cnt[24]} {timestamp_cnt[25]} {timestamp_cnt[26]} {timestamp_cnt[27]} {timestamp_cnt[28]} {timestamp_cnt[29]} {timestamp_cnt[30]} {timestamp_cnt[31]} {timestamp_cnt[32]} {timestamp_cnt[33]} {timestamp_cnt[34]} {timestamp_cnt[35]} {timestamp_cnt[36]} {timestamp_cnt[37]} {timestamp_cnt[38]} {timestamp_cnt[39]} {timestamp_cnt[40]} {timestamp_cnt[41]} {timestamp_cnt[42]} {timestamp_cnt[43]} {timestamp_cnt[44]} {timestamp_cnt[45]} {timestamp_cnt[46]} {timestamp_cnt[47]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe11]
set_property port_width 1 [get_debug_ports u_ila_0/probe11]
connect_debug_port u_ila_0/probe11 [get_nets [list log_full]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe12]
set_property port_width 1 [get_debug_ports u_ila_0/probe12]
connect_debug_port u_ila_0/probe12 [get_nets [list pileup_event]]

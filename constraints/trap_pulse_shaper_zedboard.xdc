...
connect_debug_port u_ila_0/probe2 [get_nets [list {pulse_triggers_o[0]} {pulse_triggers_o[1]} {pulse_triggers_o[2]} {pulse_triggers_o[3]} {pulse_triggers_o[4]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 32 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {log_time_o[0]} {log_time_o[1]} {log_time_o[2]} {log_time_o[3]} {log_time_o[4]} {log_time_o[5]} {log_time_o[6]} {log_time_o[7]} {log_time_o[8]} {log_time_o[9]} {log_time_o[10]} {log_time_o[11]} {log_time_o[12]} {log_time_o[13]} {log_time_o[14]} {log_time_o[15]} {log_time_o[16]} {log_time_o[17]} {log_time_o[18]} {log_time_o[19]} {log_time_o[20]} {log_time_o[21]} {log_time_o[22]} {log_time_o[23]} {log_time_o[24]} {log_time_o[25]} {log_time_o[26]} {log_time_o[27]} {log_time_o[28]} {log_time_o[29]} {log_time_o[30]} {log_time_o[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 32 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {log_pulse_o[0]} {log_pulse_o[1]} {log_pulse_o[2]} {log_pulse_o[3]} {log_pulse_o[4]} {log_pulse_o[5]} {log_pulse_o[6]} {log_pulse_o[7]} {log_pulse_o[8]} {log_pulse_o[9]} {log_pulse_o[10]} {log_pulse_o[11]} {log_pulse_o[12]} {log_pulse_o[13]} {log_pulse_o[14]} {log_pulse_o[15]} {log_pulse_o[16]} {log_pulse_o[17]} {log_pulse_o[18]} {log_pulse_o[19]} {log_pulse_o[20]} {log_pulse_o[21]} {log_pulse_o[22]} {log_pulse_o[23]} {log_pulse_o[24]} {log_pulse_o[25]} {log_pulse_o[26]} {log_pulse_o[27]} {log_pulse_o[28]} {log_pulse_o[29]} {log_pulse_o[30]} {log_pulse_o[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 15 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list {pulse_amplitude_o[0]} {pulse_amplitude_o[1]} {pulse_amplitude_o[2]} {pulse_amplitude_o[3]} {pulse_amplitude_o[4]} {pulse_amplitude_o[5]} {pulse_amplitude_o[6]} {pulse_amplitude_o[7]} {pulse_amplitude_o[8]} {pulse_amplitude_o[9]} {pulse_amplitude_o[10]} {pulse_amplitude_o[11]} {pulse_amplitude_o[12]} {pulse_amplitude_o[13]} {pulse_amplitude_o[14]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe6]
set_property port_width 1 [get_debug_ports u_ila_0/probe6]
connect_debug_port u_ila_0/probe6 [get_nets [list ce_i]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe7]
set_property port_width 1 [get_debug_ports u_ila_0/probe7]
connect_debug_port u_ila_0/probe7 [get_nets [list pulse_valid_o]]

...
connect_debug_port u_ila_0/probe0 [get_nets [list {trap_data[0]} {trap_data[1]} {trap_data[2]} {trap_data[3]} {trap_data[4]} {trap_data[5]} {trap_data[6]} {trap_data[7]} {trap_data[8]} {trap_data[9]} {trap_data[10]} {trap_data[11]} {trap_data[12]} {trap_data[13]} {trap_data[14]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 9 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {overflow_flags[0]} {overflow_flags[1]} {overflow_flags[2]} {overflow_flags[3]} {overflow_flags[4]} {overflow_flags[5]} {overflow_flags[6]} {overflow_flags[7]} {overflow_flags[8]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 6 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {pulse_triggers[0]} {pulse_triggers[1]} {pulse_triggers[2]} {pulse_triggers[3]} {pulse_triggers[4]} {pulse_triggers[5]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 12 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {pileup_cnt[0]} {pileup_cnt[1]} {pileup_cnt[2]} {pileup_cnt[3]} {pileup_cnt[4]} {pileup_cnt[5]} {pileup_cnt[6]} {pileup_cnt[7]} {pileup_cnt[8]} {pileup_cnt[9]} {pileup_cnt[10]} {pileup_cnt[11]}]]
create_debug_port u_ila_0 probe
